...
-(void)createShowMessage:(NSString *)labelTitle {
    ...
    if (!ImageView) {
        ...
        UIImageView * ShowImageView= [[UIImageView alloc]initWithFrame:CGRectMake(ScreenWidth/2 - 45, ScreenHeight/2 - 90, 90, 90)];
        ShowImageView.image = [UIImage imageNamed:@"加载中.png"];
    ...
    if (! label) {
        ...
        UILabel * Showlabel = [[UILabel alloc]initWithFrame:CGRectMake(ScreenWidth/2 - 45, ScreenHeight/2 + 15, 90, 20)];
