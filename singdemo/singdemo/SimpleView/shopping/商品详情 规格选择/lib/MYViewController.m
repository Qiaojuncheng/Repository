...
-(StandardsView *)buildStandardView:(UIImage *)img andIndex:(NSInteger)index
{
    ...
    standardClassInfo *tempClassInfo2 = [standardClassInfo StandardClassInfoWith:@"101" andStandClassName:@"绿色"];
    standardClassInfo *tempClassInfo3 = [standardClassInfo StandardClassInfoWith:@"101" andStandClassName:@"绿色"];
    standardClassInfo *tempClassInfo4 = [standardClassInfo StandardClassInfoWith:@"101" andStandClassName:@"绿色"];
    standardClassInfo *tempClassInfo5 = [standardClassInfo StandardClassInfoWith:@"101" andStandClassName:@"绿色"];
    standardClassInfo *tempClassInfo6 = [standardClassInfo StandardClassInfoWith:@"101" andStandClassName:@"蓝色绿色"];
    standardClassInfo *tempClassInfo8 = [standardClassInfo StandardClassInfoWith:@"101" andStandClassName:@"蓝色绿色"];
    standardClassInfo *tempClassInfo7 = [standardClassInfo StandardClassInfoWith:@"101" andStandClassName:@"蓝色绿色"];
    NSArray *tempClassInfoArr = @[tempClassInfo1,tempClassInfo2,tempClassInfo3,tempClassInfo4,tempClassInfo5,tempClassInfo6,tempClassInfo7,tempClassInfo8];
    StandardModel *tempModel = [StandardModel StandardModelWith:tempClassInfoArr andStandName:@"颜色"];
    
    
    
    standardClassInfo *tempClassInf3 = [standardClassInfo StandardClassInfoWith:@"102" andStandClassName:@"XL"];
    standardClassInfo *tempClassInf4 = [standardClassInfo StandardClassInfoWith:@"103" andStandClassName:@"XXL"];
    standardClassInfo *tempClassInf5 = [standardClassInfo StandardClassInfoWith:@"104" andStandClassName:@"XXXXXXXXXXXXXL"];
    NSArray *tempClassInfoArr2 = @[tempClassInf3,tempClassInf4,tempClassInf5];
