...
@property(nonatomic) NSInteger goodAttriNumber;//库存的数量 用于 加减的时候 判断 数量够不够


@property (nonatomic) void (^ShowBlock)(NSString * ShowMessage);

@property (nonatomic,strong ) NSString * iscollect;// 0 收藏 1 为收藏
/**
