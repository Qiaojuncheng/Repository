...
- (void)setSubViews {
    ...
    if (self.isSubPage) {
        tabBarHeight = TabBarHeight + 49 ;
    } else {
        tabBarHeight = TabBarHeight ;
    }
    self.myTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, NavStatusBarHeight, ScreenWidth, ScreenHeight - tabBarHeight  - NavStatusBarHeight ) style:(UITableViewStyleGrouped)];
    ...
    footView.backgroundColor = RandomColor;
    ...
    self.bottomView.frame = CGRectMake(0, ScreenHeight - TabBarHeight-49 , ScreenWidth, 49);
    //全选
